        ...
        <section className="w-screen h-screen fixed inset-0 flex justify-center items-center bg-black/50 z-50">
          <div className="w-[90%] md:w-2/6 md:max-w-md p-5 md:p-10 flex flex-col bg-white rounded-2xl justify-center items-center">
            ...
            <div className="w-full flex gap-5 mt-8">
              <button className="flex-1 border border-primary hover:bg-primary py-2 rounded-xl hover:text-white cursor-pointer">
                Download PDF
              </button>
              <Link
                href={"/dashboard"}
                className="flex-1 text-center border border-primary hover:bg-primary py-2 rounded-xl hover:text-white cursor-pointer"
              >
                Back to Home
              </Link>
            </div>
